...
| Q | K | Attention Score (A) | Softmax | Context Vector | Find Output|
|---|---|---|---|---|---|
| $Q_1(4,8)$ | $K_1(4,8)$ | $A_1 = Q_1 \times K_1^T$  | $S_1 = \bigg( \frac{e^{s_1}}{sum_1}, \frac{e^{s_2}}{sum_1}, \frac{e^{s_3}}{sum_1}, \frac{e^{s_4}}{sum_1}\bigg)$   | $O_1 = S_1 \times V_1(4,8)$ | $(O_1 \times sum_1, running-sum)$ |
