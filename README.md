...
| **L4** | **Attention Variants Part 2** — Sliding Window Attention (SWA), Linear Attention, State Space Models (SSMs), Mamba Architecture | [L4](https://github.com/muarshad01/Inference-Engg/blob/main/Lectures/Lecture-4.md) | May 05, 2026 |
