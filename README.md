...
| **Final Lecture Part 1** | Guided Decoding, eval harness, cold starts, canary deploys, cache-aware routing, guardrails | [](https://github.com/muarshad01/Inference-Engg/blob/main/Lectures/FL-part1.md) | June xx, 2026 |
| **Final Lecture Part 2** | Disaggregated serving, Building a million user production interface system | [](https://github.com/muarshad01/Inference-Engg/blob/main/Lectures/FL-part2.md) | June xx, 2026 |
